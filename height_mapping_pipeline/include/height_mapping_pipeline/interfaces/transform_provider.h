...
#ifndef HEIGHT_MAPPING_PIPELINE_INTERFACES_TRANSFORM_PROVIDER_H
#define HEIGHT_MAPPING_PIPELINE_INTERFACES_TRANSFORM_PROVIDER_H
...
#endif // HEIGHT_MAPPING_PIPELINE_INTERFACES_TRANSFORM_PROVIDER_H