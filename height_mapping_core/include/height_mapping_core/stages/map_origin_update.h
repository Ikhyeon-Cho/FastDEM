 ...
 *
 * Keeps the map centered around the robot or updates based on movement threshold.
 */
class MapOriginUpdateStage : public pipeline::Stage {
public:
   ...
   *        - "update_threshold": Movement threshold in meters (for threshold mode)
