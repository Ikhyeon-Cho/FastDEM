 ...
 * grid_map_ros.h
 *
 * Minimal GridMap <-> ROS message conversion.
 * Replaces grid_map_ros dependency for vendored grid_map_core compatibility.
 */

#ifndef HEIGHT_MAPPING_ROS_ADAPTERS_GRID_MAP_ROS_H
#define HEIGHT_MAPPING_ROS_ADAPTERS_GRID_MAP_ROS_H
...
/**
 * @brief Convert GridMap to ROS message
 * @param map Source grid map
 * @param msg Output ROS message
 */
inline void toMessage(const grid_map::GridMap& map, grid_map_msgs::GridMap& msg) {
  // Header
...
#endif  // HEIGHT_MAPPING_ROS_ADAPTERS_GRID_MAP_ROS_H
