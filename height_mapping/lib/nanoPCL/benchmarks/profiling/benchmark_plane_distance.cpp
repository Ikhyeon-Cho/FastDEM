...
// =============================================================================
inline float distanceScalar(float x, float y, float z, float a, float b, float c,
                            float d) {
  return a * x + b * y + c * z + d;
}

size_t countInliersScalar(const std::vector<Point>& points, float a, float b,
                          float c, float d, float threshold) {
  size_t count = 0;
...
size_t countInliersDot(const std::vector<Point>& points,
                       const Eigen::Vector3f& normal, float d, float threshold) {
  size_t count = 0;
  for (const auto& p : points) {
...
// =============================================================================
size_t countInliersParallel(const std::vector<Point>& points, float a, float b,
                            float c, float d, float threshold) {
  size_t count = 0;
  const size_t n = points.size();
