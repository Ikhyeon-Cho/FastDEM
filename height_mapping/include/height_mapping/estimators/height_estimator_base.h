...
#ifndef HEIGHT_MAPPING_ESTIMATORS_HEIGHT_ESTIMATOR_BASE_H
#define HEIGHT_MAPPING_ESTIMATORS_HEIGHT_ESTIMATOR_BASE_H
...
#endif  // HEIGHT_MAPPING_ESTIMATORS_HEIGHT_ESTIMATOR_BASE_H
