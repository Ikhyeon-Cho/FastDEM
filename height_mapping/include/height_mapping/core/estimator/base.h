 ...
 * base.h
 *
 * Base class for height estimation algorithms.
 *
 *  Created on: Dec 2024
 *      Author: Ikhyeon Cho
...
#ifndef HEIGHT_MAPPING_CORE_ESTIMATOR_BASE_H
#define HEIGHT_MAPPING_CORE_ESTIMATOR_BASE_H
...
#endif  // HEIGHT_MAPPING_CORE_ESTIMATOR_BASE_H
